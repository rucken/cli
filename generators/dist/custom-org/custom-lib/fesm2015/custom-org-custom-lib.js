 ...
 */
/** @type {?} */
const DEFAULT_CUSTOM_ENTITIES_CONFIG = {
    name: "custom_entity",
    ...
    actionOptions: {
        ...
        responsePaginationMeta: (data, action) => {
            return {
...
/** @type {?} */
const CUSTOM_ENTITIES_CONFIG_TOKEN = "CustomEntitiesConfig";
...
class CustomOrgCustomLibModule {
}

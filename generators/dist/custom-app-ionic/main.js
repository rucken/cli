...
var ngx_1 = __webpack_require__(/*! @ionic-native/http/ngx */ "../../node_modules/@ionic-native/http/ngx/index.js");
var ngx_2 = __webpack_require__(/*! @ionic-native/splash-screen/ngx */ "../../node_modules/@ionic-native/splash-screen/ngx/index.js");
var ngx_3 = __webpack_require__(/*! @ionic-native/status-bar/ngx */ "../../node_modules/@ionic-native/status-bar/ngx/index.js");
var angular_1 = __webpack_require__(/*! @ionic/angular */ "../../node_modules/@ionic/angular/dist/fesm5.js");
...
var ngx_remote_config_service_1 = __webpack_require__(/*! ./utils/ngx-remote-config.service */ "./src/app/utils/ngx-remote-config.service.ts");
        ...
        core_1.NgModule({
            ...
            imports: [
                ...
                ngx_remote_config_1.NgxRemoteConfigModule.forRoot({
                    ...
                    url: environment_1.environment.remoteConfig.url,
                    default: environment_1.environment.remoteConfig.default
                }),
            ...
            providers: [
                ngx_1.HTTP,
                {
                    provide: ngx_remote_config_1.NgxRemoteConfigService,
                    useClass: ngx_remote_config_service_1.NgxRemoteConfigIonicService
                },
                {
...
/***/ "./src/app/utils/ngx-remote-config.service.ts":
/*!****************************************************!*\
  !*** ./src/app/utils/ngx-remote-config.service.ts ***!
  \****************************************************/
/*! no static exports found */
...
var angular_1 = __webpack_require__(/*! @ionic/angular */ "../../node_modules/@ionic/angular/dist/fesm5.js");
var ngx_remote_config_1 = __webpack_require__(/*! ngx-remote-config */ "../../node_modules/ngx-remote-config/fesm5/ngx-remote-config.js");
var NgxRemoteConfigIonicService = /** @class */ (function (_super) {
    tslib_1.__extends(NgxRemoteConfigIonicService, _super);
    function NgxRemoteConfigIonicService(http, platform, options, httpClient) {
        var _this = _super.call(this, options, httpClient) || this;
        _this.http = http;
    ...
    NgxRemoteConfigIonicService.prototype.initConfigAsync = function () {
        var _this = this;
        if (this.platform.is("cordova")) {
            return new Promise(function (resolve) {
                return _this.http.disableRedirect(false).then(function (result) {
                    return _this.http.get(_this.options.url, {}, {}).then(function (response) {
                        var config;
                        try {
                        ...
                        var config = _this.options.default || {};
                        _this.config$.next(config);
                        resolve(config);
                    });
                });
        ...
        return _super.prototype.initConfigAsync.call(this);
    };
    NgxRemoteConfigIonicService = tslib_1.__decorate([
        core_1.Injectable(),
        tslib_1.__param(2, core_1.Inject(ngx_remote_config_1.NGX_REMOTE_CONFIG)),
        tslib_1.__metadata("design:paramtypes", [ngx_1.HTTP,
            angular_1.Platform, Object, http_1.HttpClient])
    ], NgxRemoteConfigIonicService);
    return NgxRemoteConfigIonicService;
}(ngx_remote_config_1.NgxRemoteConfigService));
exports.NgxRemoteConfigIonicService = NgxRemoteConfigIonicService;

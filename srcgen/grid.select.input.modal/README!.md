...
<prompt name="module.core" message="Core module">core</prompt>
<prompt name="module.platform" message="Platform module">web</prompt>
<prompt name="module.coreFolder" message="Core module">core</prompt>
<prompt name="module.platformFolder" message="Platform module">web</prompt>

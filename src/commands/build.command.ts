...
export class BuildCommand extends BaseCommand {
    ...
    processLibs(folders: string[], rootFolder: string) {
        this.log.info('Build all libs on ' + this.rootFolder);
    ...
    processLib(folder: string, rootFolder: string) {
        this.log.info('Build lib ' + folder + ' on ' + rootFolder);
    ...
    processApps(folders: string[], rootFolder: string) {
        this.log.info('Build all apps on ' + rootFolder);
    ...
    processApp(folder: string, rootFolder: string) {
        this.log.info('Build app ' + this.action.parent.app + ' on ' + rootFolder);
